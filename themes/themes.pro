...
theme_files.path = $$PREFIX/share/themes/Ambiance/qmltheme
theme_files.files = $$THEME_FILES

ARTWORK_FILES += \
    Ambiance/qmltheme/artwork/*.png \
    Ambiance/qmltheme/artwork/*.sci
theme_artworks.path = $$PREFIX/share/themes/Ambiance/qmltheme/artwork
theme_artworks.files = $$ARTWORK_FILES

qmldir_file.path = $$PREFIX/share/themes/Ambiance/qmltheme
qmldir_file.files = $$QMLDIR_FILE

qml_files.path = $$PREFIX/share/themes/Ambiance/qmltheme
